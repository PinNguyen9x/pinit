...
export interface KnowledgeTrack {
  ...
  blurb: string
  /**
   * Bài thuộc track nếu có ÍT NHẤT MỘT tag nằm trong danh sách này (không phân
   * biệt hoa thường). Đây là nguồn duy nhất: card trang chủ đếm theo cụm này,
   * và /blog?track=<key> cũng lọc theo đúng cụm này, nên số ghi trên card luôn
   * bằng số bài hiện ra khi bấm vào.
   */
  tags: string[]
}
