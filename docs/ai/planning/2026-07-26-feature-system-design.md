...
- [ ] **M4 — Case study (buổi 7–12)** — 🔄 4/6 xong: buổi 7, 8, 9, 10
...
### 3 việc tiếp theo
1. **T4.5** — buổi 11: case study đặt xe — ⚠️ đầu mục là giả định, cần đối chiếu
2. **T4.6** — buổi 12: case study nhắn tin, khép lại M4
3. **T5.1** — buổi 13 tự luyện, dùng lại `INTERVIEW_STEPS`
